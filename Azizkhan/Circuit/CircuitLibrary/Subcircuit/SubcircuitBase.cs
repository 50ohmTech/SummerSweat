...
namespace CircuitLibrary.Subcircuits
{
    ...
    public abstract class SubcircuitBase : INode
    {
        ...
        //Мы используем стандартный класс Nodes. Добавление дочерних элементов работает через стандартную функцию Add.
        //По-моему это невыполнимая ТУДУшка.
        //Тем более, что Nodes закрыто на запись, то есть присвоить туда другой лист мы не можем.
        /// <summary>
